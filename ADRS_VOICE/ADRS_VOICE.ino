...
bool trigger = false;
//gate settings
int gate_on_response = 60; // difference between SHORT1 & 2 needed for gate to turn on 
int SHORT1_SMOOTHING = 300; // SHORT1 Smoothing
int SHORT2_SMOOTHING = 500; // SHORT2 Smoothing
...
if(!gate){comp_adjust = 0;trigger = true;}else{trigger =false;}
...
if (trigger){CHANGE_STATUS();}
  Master = comp_adjust;
  if (profilearray[8]==1){AWIN = AWIN - ENV_ADJUST;}else{AWIN = 0.00-(AWIN+ENV_ADJUST);} //UP OR DOWN
