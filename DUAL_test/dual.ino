...
if((unsigned long)(micros() - count_down) == intervaltime) {TOGGLE_HW_RELAY();}
if((unsigned long)(micros() - count_down) == (intervaltime2)) {digitalWrite(phototrans, LOW);}  
